...
namespace Steam
{
    public class Bot
    {
        ...
        /// </summary>
        public void SendMessage(SteamID User, string message)
        {
            this.SteamFriends.SendChatMessage(User, EChatEntryType.ChatMsg, message);
        }
        ...
        public SteamID MySID { get { return this.SteamUser.SteamID; } }
        ...
        bool HandleTradeSessionStart (SteamID other)
        {
            ...
            catch (InventoryFetchException ie)
            {
